...
\sidecaption[][-2cm]{When such a measurement is impossible. (Is the method applicable for a shadow cast by a streetlamp?)\label{fig-01-02}}
\end{figure}
...
\sidecaption[][-2cm]{Height measurement using a mirror.\label{fig-01-14}}
\end{figure}
...
\sidecaption{What is a ``species number''?\label{fig-01-21}}
\end{figure}
