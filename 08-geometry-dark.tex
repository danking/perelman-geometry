...
\sidecaption{The young adventurer from the novel by Mein-Reid.\label{fig-108}}
\end{figure}
...
\sidecaption{Tight wrapping of the barrel with hoops is achieved by pushing them over a wide part.\label{fig-110}}
\end{figure}
...
\sidecaption{The schematic depiction of the experiment at St. Mark's Square in Venice.\label{fig-112}}
\end{figure}
...
\sidecaption{The simplest right-angled triangle, the lengths of whose sides correspond to these numbers.\label{fig-122}}
\end{figure}
